...
```bash
/Users/cory/.coding-cli/skills/humanize
```
...
flowchart TD
    ...
    LOAD_CFG --> VALIDATE[Validate IO<br/>Run: /Users/cory/.coding-cli/skills/humanize/scripts/validate-refine-plan-io.sh --input &lt;annotated-plan&gt; [--output ...] [--qa-dir ...] [--discussion|--direct]]
    ...
    PLAN_CHECK -->|Yes| QA[Populate QA document from<br/>/Users/cory/.coding-cli/skills/humanize/prompt-template/plan/refine-plan-qa-template.md]
