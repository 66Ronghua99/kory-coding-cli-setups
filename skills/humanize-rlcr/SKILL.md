...
All commands below assume `/Users/cory/.coding-cli/skills/humanize`.
...
```bash
"/Users/cory/.coding-cli/skills/humanize/scripts/setup-rlcr-loop.sh" $ARGUMENTS
```
...
```bash
"/Users/cory/.coding-cli/skills/humanize/scripts/cancel-rlcr-loop.sh"
```
