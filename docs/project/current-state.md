...
- [`superpowers`](/Users/cory/.coding-cli/superpowers) is synced by the local Bash and PowerShell sync scripts, which clone it when missing and fast-forward it when present.
- The sync scripts generate a curated set of top-level links under [`skills/`](/Users/cory/.coding-cli/skills) that point into [`superpowers/skills`](/Users/cory/.coding-cli/superpowers/skills); those generated links are ignored by Git instead of being tracked.
- The Bash implementation keeps the existing downstream target layout:
  ...
  - `.codex/AGENTS.md`, `.codex/config.toml`, `.codex/agents`, `.codex/skills/<skill-name>`
